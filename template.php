...
<body class="container">
    ...
    <div id="table" class="form-group">
        ...
        <!-- Modal que será aberto para cadastro -->
        ...
        <!-- Modal que será aberto para editar -->
        ...
        <div class="window" id="janela2">
            ...
            <form id="editUsuario" action="" method="post">
                ...
                <label>Nome:</label><input type="text" name="nome" id="nomeEdit" />
                <label>E-mail:</label><input type="mail" name="email" id="emailEdit" />
                <label>Senha:</label><input type="password" name="senha" id="senhaEdit" />
                <br/><br/>
                <input type="button" value="Salvar" id="salvarEdit">
            </form>
        </div>
        <div id="mascara"></div>
    </div>
